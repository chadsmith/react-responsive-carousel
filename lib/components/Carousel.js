...
var Carousel = function (_Component) {
    ...
    function Carousel(props) {
        ...
        _this.selectItem = function (state) {
            ...
            if (!fromProps) _this.handleOnChange(state.selectedItem, _this.props.children[state.selectedItem]);
        };
...
Carousel.propTypes = {
    ...
    allowPeek: _propTypes2.default.bool,
